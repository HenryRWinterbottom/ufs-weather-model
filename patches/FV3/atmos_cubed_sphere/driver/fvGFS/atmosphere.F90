...
#else
   nlunit = open_namelist_file ( ) ! Bug fix; HRW 20221119
   ierr=1
   do while (ierr /= 0)
      read  (nlunit, nml=atmos_model_nml, iostat=io, end=10) ! Bug fix; HRW 20221119
      ierr = check_nml_error(io,'atmos_model_nml')
   enddo
10 call close_file (nlunit) ! Bug fix; HRW 20221119
#endif
